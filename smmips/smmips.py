...
def assign_smmips(outdir, sortedbam, prefix, chromosome, remove, panel, upstream_nucleotides,
    ...
    if chromosome == 'all':
        ...
        sort_index_bam(assigned_filename, '.{0}.temp.assigned_reads.sorted.bam'.format(chromosome))
        sort_index_bam(unassigned_filename, '.{0}.temp.unassigned_reads.sorted.bam'.format(chromosome))
        sort_index_bam(empty_filename, '.{0}.temp.empty_reads.sorted.bam'.format(chromosome))
